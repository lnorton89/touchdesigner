...
- Added `examples/phase1_async_router/demo_callbacks.py` with a structured `onRouterResult(payload)` demo callback.
- Added `examples/phase1_async_router/README.md` with a reproducible TouchDesigner network layout, safe localhost defaults, and manual verification checklist.
...
1. Assemble the network from `examples/phase1_async_router/README.md`.
